...
<html>
  ...
  <body>
  <center>
    <form name="form1" method="post" action="userInfo.action">
        ...
        <tr>
          ...
          <td><label>
            <select name="user.profile" id="profile" onChange="show(this.form)">
              <option value="profile/1.jpg">头像1</option>
            ...
            <img name="showface" src=<s:property value="#session.user.profile"/> width="40" height="40" /></label></td>
        </tr>
        <tr>
          <td>电子邮件：</td>
          <td><label>
            <input name="user.email" type="text" id="title" size="45" value=<s:property value="#session.user.email"/>>
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
